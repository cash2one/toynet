...
public:
	...
	static BYTE * JpegFileToRGB(LPCTSTR fileName,			// path to image
							   UINT *width,					// image width in pixels
							   UINT *height);				// image height

	static BYTE * JpegFileToRGB(FILE* infile,				// file pointer
							   UINT *width,					// image width in pixels
							   UINT *height);				// image height
	...
	static BOOL RGBToJpegFile(LPCTSTR fileName,				// path
	...
	static BOOL GetJPGDimensions(LPCTSTR fileName,			// path
								UINT *width,				// pixels
								UINT *height);

	static BOOL GetJPGDimensions(FILE* infile,				// file pointer
								UINT *width,				// pixels
								UINT *height);
